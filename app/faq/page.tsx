...
const faqData = [
  ...
  { question: 'How much does a Taj Mahal photoshoot cost?', answer: 'Packages start at $99 USD for the Basic Package (1-1.5 hours, 50 high-resolution photos). The Standard Package is $199 (2+ hours, 50 edited photos + 100+ natural photos). Family Vacation is $299, and the Premium Taj & Agra Fort Package is $399. All packages include official permit authorization.' },
  ...
  { question: 'Do you provide transportation?', answer: 'Transportation is included in the Premium Taj & Agra Fort Package ($399). For other packages, hotel pickup can be arranged at an additional cost. We can recommend reliable transport options for your Agra visit.' },
];
