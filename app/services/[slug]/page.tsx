...
const servicesData: Record<string, { title: string; description: string; longDescription: string; image: string; features: string[]; price: number; duration: string; bestFor: string }> = {
  couple: {
    ...
    features: ['2+ Hour Session', '50 Professionally Edited Photos', '100+ Natural High-Resolution Photos', 'Outfit Change Guidance (Outside Gates)', 'Posing Direction & Creative Styling'],
    price: 199,
    duration: '2+ Hours',
