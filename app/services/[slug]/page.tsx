...
const servicesData: Record<string, ServiceData> = {
  ...
  'guided-photo-tour-small': {
    ...
    description: 'A licensed local guide plus a professional photographer at the Taj Mahal and Agra Fort, with 20 digital and 20 printed photos. $50 total for up to 5 guests.',
    quickAnswer:
      'A budget-friendly guide + photographer combo at the Taj Mahal and Agra Fort for 1 to 5 guests. $50 USD total. Includes a licensed local guide, a professional photographer, 20 natural high-resolution digital photos and 20 premium printed photo copies. Monument entry tickets are not included.',
    longDescription:
      'This combo package pairs a licensed local guide with a professional photographer for a single fixed price across the Taj Mahal and Agra Fort. The guide narrates the Mughal history of both monuments while the photographer captures you at every iconic vantage point — the reflecting pool, the elevated platform, the gardens at the Taj, the Diwan-i-Khas, Sheesh Mahal and the famous balcony view of the Taj from Agra Fort. You receive 20 natural high-resolution digital photos and 20 premium printed copies. Best for couples, solo travellers and small families up to 5 guests. Monument entry tickets are separate.',
    image: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?q=80&w=1920&auto=format&fit=crop',
    features: [
    ...
    faqs: [
      { question: 'How many people does the $50 small-group package cover?', answer: 'The $50 USD price is for up to 5 guests in total. For groups of 6 or more, the $80 large-group package is the right choice.' },
      ...
      { question: 'Do I get both digital and printed photos?', answer: 'Yes — 20 natural high-resolution digital photos delivered to a private gallery, plus 20 premium printed photo copies.' },
  ...
  'guided-photo-tour-large': {
    ...
    description: 'The same guide + photographer combo at the Taj Mahal and Agra Fort, scaled up for groups of 6 to 12 guests. Group portraits plus individual portraits. $80 total.',
    quickAnswer:
      'A guide + photographer combo at the Taj Mahal and Agra Fort for groups of 6 to 12 guests. $80 USD total. Includes a licensed local guide, a professional photographer, group portraits and individual portraits, 20 natural high-resolution digital photos and 20 premium printed photo copies. Monument entry tickets are not included.',
    longDescription:
      'Built for larger families and friend groups visiting Agra together, this package covers up to 12 guests for a single fixed price. The licensed local guide narrates the Mughal history of the Taj Mahal and Agra Fort while the photographer captures group portraits alongside individual portraits at every iconic spot. You receive 20 natural high-resolution digital photos and 20 premium printed copies for the group. Monument entry tickets are separate. For groups of 5 or fewer, the $50 small-group package is the right pick.',
    image: 'https://images.unsplash.com/photo-1548013146-72479768bada?q=80&w=1920&auto=format&fit=crop',
    features: [
      'Licensed local guide for Taj Mahal & Agra Fort',
      'Professional photographer alongside',
    ...
    faqs: [
      { question: 'How many people does the $80 large-group package cover?', answer: 'Up to 12 guests in total. Larger groups can be split into multiple packages — message us on WhatsApp for a tailored quote.' },
      ...
      { question: 'How is this different from the Heritage Trail ($399)?', answer: 'This $80 combo focuses on a guided walk plus 20+20 photographs. The Heritage Trail is a 5-hour dedicated photography session with 250+ high-resolution photos and a fully managed schedule — more output, no group cap.' },
    ],
  },
  proposal: {
