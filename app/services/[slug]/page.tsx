...
const servicesData: Record<string, ServiceData> = {
  ...
  'transport-guide': {
    title: 'Transport + Guide | Private Car & Licensed Guide, Agra & Beyond',
    description: 'A private A/C car with chauffeur plus a Ministry of Tourism licensed guide, starting from $100 USD. You choose the cities and the number of days — the exact quote is confirmed on WhatsApp. No photographer included.',
    quickAnswer:
      'A customisable private tour combo: an air-conditioned car with a professional chauffeur plus a Ministry of Tourism licensed guide, starting from $100 USD. You pick the cities — Agra, Delhi, Jaipur, Mathura-Vrindavan — and the number of days, and we confirm one clear all-in quote on WhatsApp before you commit. No photographer is included, so it is ideal if you shoot on your own phone or camera. Monument entry tickets are not included.',
    longDescription:
      'Transport + Guide keeps the money side simple: tell us which cities you want to cover and how many days you have, and we reply on WhatsApp with one clear quote — starting from $100 USD for a single-day Agra itinerary. No inflated bundles, no vague inclusions, no surprises at the car door. A private air-conditioned car with a professional chauffeur handles every transfer, and a Ministry of Tourism licensed guide brings the history to life — the Taj Mahal and Agra Fort in Agra, and on multi-day routes the highlights of Delhi, Jaipur or Mathura-Vrindavan as well. The guide knows every good phone-photo and selfie spot and will happily take shots of you on your own device; there is simply no professional photographer in this package, which is what keeps it lean. Monument entry tickets stay separate and are always listed in your quote so you can see exactly where every dollar goes.',
    image: 'https://images.unsplash.com/photo-1548013146-72479768bada?q=80&w=1920&auto=format&fit=crop',
    features: [
      'Starting from $100 USD — exact quote confirmed on WhatsApp before you book',
      'Private A/C car with professional chauffeur',
      'Ministry of Tourism licensed local guide',
      'Your choice of cities: Agra, Delhi, Jaipur, Mathura-Vrindavan',
      'Your choice of days — from a single day to a full circuit',
      'Hotel or railway station pickup',
    ...
    itinerary: [
      { time: 'Step 1', title: 'Tell us your route', detail: 'Pick your cities (Agra, Delhi, Jaipur, Mathura-Vrindavan) and the number of days in the booking form.' },
      { time: 'Step 2', title: 'Get one clear quote', detail: 'We reply on WhatsApp within 10 minutes with a single all-in price for your route — starting from $100 for a one-day Agra itinerary.' },
      { time: 'Step 3', title: 'Guided travel days', detail: 'The private A/C car and licensed guide cover your chosen cities at your pace — Taj Mahal and Agra Fort in Agra, and the highlights of any other city on your route.' },
      { time: 'Step 4', title: 'Drop wherever suits you', detail: 'End at your hotel, a railway station or the airport — whatever fits your onward plans.' },
    ],
    faqs: [
      { question: 'How much does the Transport + Guide package cost?', answer: 'It starts from $100 USD for a single-day Agra itinerary with a private A/C car and a Ministry of Tourism licensed guide. Multi-city or multi-day routes cost more — tell us your cities and days and we confirm one all-in quote on WhatsApp before you book. Monument entry tickets are not included.' },
      { question: 'Which cities can the tour cover?', answer: 'Agra (Taj Mahal and Agra Fort) is the base. You can extend to Delhi, Jaipur and Mathura-Vrindavan — the classic Golden Triangle — over as many days as you like.' },
      { question: 'Is a photographer included?', answer: 'No — this package deliberately excludes the photographer, which keeps the price lean. If you want professional photos, choose a Guided Tour + Photo combo ($79 / $99) or a photography package.' },
      ...
      { question: 'Is this a round trip?', answer: 'Only if you want it to be. The route is built around your plans — start in one city and end in another, or loop back to your hotel. Pickup and drop points are agreed in the WhatsApp quote.' },
    ],
  },
