      ...
      <main id="main-content" className="flex-grow bg-night">
        <div className="bg-night bg-mughal-pattern border-b border-line py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="display-tight font-display text-4xl md:text-5xl font-semibold text-ivory">Terms of Service</h1>
          </div>
        </div>

        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <article className="prose prose-invert prose-lg max-w-none">
            <p className="text-faint text-sm">Last updated: January 1, 2025</p>

            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">1. Services</h2>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">2. Booking and Confirmation</h2>
            <ul>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">3. Monument Entry Tickets</h2>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">4. Cancellation and Refund Policy</h2>
            <ul>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">5. Photo Delivery</h2>
            <ul>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">6. Intellectual Property</h2>
            <ul>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">7. Client Conduct</h2>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">8. Liability</h2>
            <ul>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">9. Changes to Terms</h2>
            ...
            <h2 className="font-display text-2xl text-ivory mt-10 mb-4">10. Contact</h2>
