  ...
  return {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        offerSchema('Guided Tour + Photo Combo (Small Group, 1–5 Guests)', 89, 'Licensed local guide plus professional photographer at Taj Mahal, Agra Fort & Mehtab Bagh / Itmad-ud-Daulah for up to 5 guests. 40 natural digital photos + 5 reels. Monument tickets not included.', `${SITE.url}/services/guided-photo-tour-small`),
        offerSchema('Guided Tour + Photo Combo (Large Group, 6–12 Guests)', 119, 'Licensed local guide plus professional photographer at Taj Mahal, Agra Fort & Mehtab Bagh / Itmad-ud-Daulah for groups of 6 to 12. Group + individual portraits, 60 digital photos + 7 reels. Monument tickets not included.', `${SITE.url}/services/guided-photo-tour-large`),
