  ...
  return {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        offerSchema('Transport + Guide (Private Car, No Photography)', 100, 'Private A/C car with chauffeur plus a Ministry of Tourism licensed guide, starting from $100 USD. Customer chooses the cities (Agra, Delhi, Jaipur, Mathura-Vrindavan) and number of days; exact quote confirmed on WhatsApp. No photographer. Monument tickets not included.', `${SITE.url}/services/transport-guide`),
