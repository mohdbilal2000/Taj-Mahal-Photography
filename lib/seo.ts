...
export function localBusinessSchema() {
  return {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        offerSchema('Quick Capture', 49, 'Budget-friendly Taj Mahal photoshoot. 30-minute session, 30 raw photos delivered as a digital album.', `${SITE.url}/services/quick-capture`),
        ...
        offerSchema('Transport + Photography (Agra)', 129, 'Private A/C car with chauffeur plus a government-licensed photographer for a half day in Agra. Hotel or railway station pickup, Taj Mahal & Agra Fort covered, 60+ high-resolution photos delivered within 48 hours. Monument tickets not included.', `${SITE.url}/services/transport-photography`),
        offerSchema('Transport + Guide (Agra, No Photography)', 89, 'Private A/C car with chauffeur plus a Ministry of Tourism licensed guide for a half day at the Taj Mahal & Agra Fort. No photographer — shoot your own photos. Monument tickets not included.', `${SITE.url}/services/transport-guide`),
