  ...
  return {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        offerSchema('Guided Tour + Photo Combo (Small Group, 1–5 Guests)', 50, 'Licensed local guide plus professional photographer at Taj Mahal & Agra Fort for up to 5 guests. 20 natural digital photos + 20 premium printed copies. Monument tickets not included.', `${SITE.url}/services/guided-photo-tour-small`),
